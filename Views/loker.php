  ...
  <nav class="news-nav">
    <div class="nav-container">
      <ul class="nav-menu">
        ...
        <li><a href="loker.php" class="active"><i class="fas fa-briefcase"></i> Loker</a></li>
        ...
        <?php if (!empty($loker_list)): ?>
          <?php foreach ($loker_list as $loker): ?>
            <article class="news-card">
              <img src="<?= htmlspecialchars($loker['gambar']) ?>" alt="<?= htmlspecialchars($loker['judul']) ?>" class="news-img">
              <div class="news-content">
                <span class="category"><?= htmlspecialchars($loker['kategori']) ?></span>
                <h3><?= htmlspecialchars($loker['judul']) ?></h3>
                <p><?= htmlspecialchars($loker['deskripsi']) ?></p>
                <div class="meta">
                ...
                <a href="loker_detail.php?id=<?= $loker['id'] ?>" class="apply-btn" style="
                  display:inline-block;margin-top:8px;background:#c62828;
